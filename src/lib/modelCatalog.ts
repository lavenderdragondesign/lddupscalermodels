...
// Friendly presets — change the right side to your actual folder names
export const PRESETS = {
  auto: { label: 'Best Auto',   hint: 'Chooses for you based on image & size.', path: 'realesrgan/general_plus-128' },
  ...
  a4x:  { label: 'Anime 4×',    hint: 'Crisp detailed anime output.',           path: 'realcugan/2x-conservative-256' }
} as const
