...
<div :class="['ldd-splash', { hidden: !showSplash }]">
  <img class="logo" src="https://i.postimg.cc/bwK2cRY0/download-20.png" alt="LavenderDragonDesign logo" referrerpolicy="no-referrer" />
  <div class="title">Loading LavenderDragonDesign's Upscaler</div>
...
export default {
  data() {
    return { showSplash: true, showSplash: true,
    return {
      dragging: false,
      touching: false,
      imgX: 0,
